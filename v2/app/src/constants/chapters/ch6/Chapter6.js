	...
	sub: [
...

		{
			...
			sub: [
			{
				...
				<p>Simulate the following instructions:</p>
			...
			table, th, td {
			 ...
			 tr {
				...
				<tr>
					...
					<td width= "400" align= "right">MOV AX, 1234</td>
					<td>AX= </td>
				</tr>
				<tr>
					<td align= "right">MOV BX, 4568</td>
					<td>BX=</td>
				</tr>
				<tr>
					<td align="right">OR  AX, BX</td>
					<td>AX=</td>
				</tr>
				<tr>
					<td align= "right">MOV DX, 3782</td>
					<td>DX=</td>
				</tr>
				<tr>
					<td align= "right">AND DX, AX</td>
					<td>DX=</td>
				</tr>
				<tr>
					<td align= "right">XOR BX, DX</td>
					<td>BX=</td>
				</tr>
				<tr>
					<td align= "right">NOT AX</td>
					<td>AX=</td>
				</tr>
				<tr>
					<td align= "right">NEG BX</td>
					<td>BX=</td>
				</tr>
				<tr>
					<td align= "right">SUB BX, AX</td>
					<td>BX=</td>
				</td>
				</tr>
				</table>
